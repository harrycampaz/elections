...
public class LiderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent intentAgregarLider = new Intent(this, AgregarLiderActivity.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               startActivity(intentAgregarLider);
            }
        });
