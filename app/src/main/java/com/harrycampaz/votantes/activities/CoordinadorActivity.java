...
public class CoordinadorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent intentAgregarCoordinador = new Intent(this, AgregarCoordinadorActivity.class);
        candidato = (Candidato) getIntent().getSerializableExtra("lider");

        FloatingActionButton fab = findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               startActivity(intentAgregarCoordinador);
            }
        });
    ...
    private void getData(){
        ...
        if(candidato != null){
            ...
            usuList = votacionesDBHelper.getCoordinadores();
        }
